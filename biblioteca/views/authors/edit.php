...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <form method="POST" action="index.php?action=authors_update&id=<?php echo $author['id']; ?>">
                <label for="name">Nombre del Autor:</label>
                <input type="text" name="name" value="<?php echo htmlspecialchars($author['name']); ?>" required><br><br>
